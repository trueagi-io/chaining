...
set ylabel "Time(ms) / solution ratio"
set yrange [0:0.5]
set output "plots/backward-time-solution-ratio.png"
set datafile missing NaN
set datafile separator ","
set datafile commentschars "c"
plot "benchmark.csv" using (strcol(1) eq "backward" && strcol(2) eq "petta" && $4 == 4 ? $5 / 6087113 : NaN):($6 * 1000 / $5) t "PeTTa" with lines smooth unique
